...
class _ProfilePageState extends State<ProfilePage>
  ...
  void _deleteSelected() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: const Text('Sestavine odstranjene'),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                const Text('jan.novak@email.com',
                    style: TextStyle(
  ...
  Widget _buildTabBar() {
    return Container(
      ...
      decoration: BoxDecoration(
        color: Colors.white, borderRadius: kRadius12,
  ...
  Widget _buildCookedTab() {
    if (_cooked.isEmpty) {
      return _buildEmptyState('Ni kuhannih obrokov', Icons.soup_kitchen);
    }
        ...
        children: [
          Text(
            ...
            style: const TextStyle(
                fontWeight: FontWeight.w700, color: kGreenMid, fontSize: 13),
          ),
          const Spacer(),
          GestureDetector(
